...
for IP = 1:3
  ...
  NPT = 2 * nvar + 1;
  CALFUN = @(n, x)(calfun(prob, n, x));
  CALGREY = @(x, k, f, e, e1, e2, rd) ...
    (calgrey(x, nvar, k, f, e, e1, e2, rd, prob, FLAG_Epsilonk));
  [X, NF] = newuoa_trans(CALFUN, CALGREY, nvar, NPT, X, 1.0e0, 1.0e-6, 0, 10000, flag);
